...
Nützlich ist die Ausgabe des range-Objekts in eine Liste, einen Sammeltyp, der im nächsten Kapitel behandelt wird.

```{python}
print(list(range(0, 11, 2)))
```

start und stop können auch negativ sein, step nicht. Um rückwärts zu zählen braucht man die Funktion reversed(seq)
tuple(reversed(range(-20, 5)))
