...
::: {.border}
![Logo der Programmiersprache Python](00-bilder/python-logo-and-wordmark-cc0-tm.png){fig-alt="Logo der Programmiersprache Python"}
...
Wir lassen uns die Worte 'Hallo Welt' ausgeben. Dazu nutzen wir den print-Befehl
 `print()`:
...
- Der Text `"Hallo Welt!"` wird angezeigt.
